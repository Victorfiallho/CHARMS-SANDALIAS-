...
const PRODUCTS: Product[] = [
  ...
  { id: "8",  nome: "Melissa Possession",      categoria: "Premium",   preco: 249.90, precoAnt: 299.90, disponivel: true,  destaque: true,  cores: ["#EDE5E2","#9D174D"],  numeracao: "33-40", sku: "ML-PO-008"  },
    ...
    <>
      ...
      <div style={{ flex: 1, overflow: "auto", display: "flex", flexDirection: "column", background: "#FAF9F6" }}>
        ...
        <div style={{ background: "white", borderBottom: "1px solid #EDE5E2", padding: "0 1.25rem", height: 44, display: "flex", gap: "0.625rem", alignItems: "center", flexShrink: 0 }}>
          ...
          <select value={dispFiltro} onChange={(e) => setDispFiltro(e.target.value as typeof dispFiltro)} style={{ padding: "0.28rem 0.5rem", border: "1px solid #EDE5E2", borderRadius: 4, fontSize: "0.72rem", fontFamily: "inherit", outline: "none", background: "white", color: "#4A3535" }}>
          ...
          {viewMode === "grid" ? (
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(200px, 1fr))", gap: "0.75rem" }}>
              {filtered.map((p) => (
                ...
                >
                  {/* Imagem placeholder */}
                  <div style={{ height: 100, background: "#F5F2EF", display: "flex", alignItems: "center", justifyContent: "center", position: "relative" }}>
                  ...
                  <div style={{ padding: "0.625rem 0.75rem" }}>
                    ...
                    <div style={{ display: "flex", alignItems: "baseline", gap: 4, marginBottom: "0.375rem" }}>
                      ...
                      {p.precoAnt && <span style={{ fontSize: "0.62rem", color: "#9A7878", textDecoration: "line-through" }}>{fmt(p.precoAnt)}</span>}
                    </div>
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                      <div style={{ display: "flex", gap: 2 }}>
                        ...
                        {p.cores.length > 5 && <span style={{ fontSize: "0.55rem", color: "#9A7878" }}>+{p.cores.length - 5}</span>}
                      </div>
                ...
                {filtered.map((p) => (
                  ...
                  >
                    ...
                    <td style={{ padding: "0.625rem 1rem" }}>
                      ...
                      {p.precoAnt && <div style={{ fontSize: "0.62rem", color: "#9A7878", textDecoration: "line-through" }}>{fmt(p.precoAnt)}</div>}
                    </td>
                    <td style={{ padding: "0.625rem 1rem" }}>
