...
const IgIcon = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="#9D174D">
...
const BlingIcon = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#A16207" strokeWidth="2" strokeLinecap="round">
    ...
    <>
      <header className="page-header">
        <div>
          ...
          <p className="page-header-sub">Integrações e credenciais</p>
        </div>
      </header>
      ...
      <div style={{ flex: 1, overflow: "auto", padding: "1.25rem", background: "#F9FAFB" }}>
        <div style={{ maxWidth: 820, margin: "0 auto" }}>
          ...
          <Section title="WhatsApp Business" icon={<WppIcon />} status="pendente" fields={[
            { label: "Phone Number ID",          placeholder: "123456789012345" },
            { label: "WA Business Account ID",   placeholder: "987654321098765" },
            { label: "Access Token",             placeholder: "EAAxxxxxxx…", type: "password" },
            { label: "Webhook Verify Token",     placeholder: "meu-token-secreto" },
          ]} />

          <Section title="Instagram" icon={<IgIcon />} status="pendente" fields={[
            { label: "Page ID",      placeholder: "123456789" },
            { label: "Access Token", placeholder: "EAAxxxxxxx…", type: "password" },
          ]} />

          <Section title="Bling ERP" icon={<BlingIcon />} status="pendente" fields={[
          ...
          <div style={{ background: "white", borderRadius: 4, border: "1px solid #FECACA", padding: "0.875rem 1rem" }}>
            ...
            <div style={{ display: "flex", gap: "0.5rem" }}>
              <button disabled style={{
                ...
                borderRadius: 4, padding: "0.32rem 0.75rem",
                fontSize: "0.72rem", fontWeight: 600, cursor: "not-allowed",
                opacity: 0.5, fontFamily: "inherit",
              }}>
